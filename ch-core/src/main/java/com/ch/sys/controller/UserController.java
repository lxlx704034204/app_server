...
public class UserController extends BaseController<User>{
	...
	synchronized public void reg(User data,HttpServletRequest request,HttpServletResponse response,HttpSession session,PrintWriter pw) {
		Json json = new Json();
		...
		if (user != null) {
			...
			service.save(u);
			login(user,request,response,session,pw);
		}
	}
	...
	public void login(User data,HttpServletRequest request,HttpServletResponse response,HttpSession session,PrintWriter pw) {
		HqlFilter hqlFilter = new HqlFilter();
		hqlFilter.addFilter("QUERY_t#loginname_S_EQ", data.getLoginname());
